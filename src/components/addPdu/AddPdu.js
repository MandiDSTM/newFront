        ...
        <div>
            <div className="flex flex-col gap-5 w-full bg-white h-[80vh] justify-center items-center">
                <div className="flex flex-col gap-5">
                    <h1 className="self-center text-2xl mb-7">Adding PDU</h1>
                    <div className="flex w-[400px] justify-between">
                        <label htmlFor="id">PDU Serial Number</label>
                    ...
                    <div className="flex w-[400px] justify-between">
                        <label className="mr-5" htmlFor="id">Person Phone Number</label>
